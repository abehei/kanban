...
export function Column({
  ...
  return (
    <div className="flex w-64 flex-shrink-0 flex-col rounded-xl bg-slate-50 border border-slate-200">
      {/* カラムヘッダー */}
      ...
      <div
        ...
        className={[
          ...
          isOver ? "bg-blue-50/50 rounded-b-xl" : "",
        ].join(" ")}
      >
        ...
        {tasks.length === 0 && (
          <div className="flex flex-1 items-center justify-center text-xs text-slate-400 py-4">
            タスクなし
          </div>
        )}
      </div>
