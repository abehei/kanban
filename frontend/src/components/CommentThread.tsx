    ...
    <div className="flex flex-col gap-3">
      ...
      <div className="flex flex-col gap-2 max-h-48 overflow-y-auto">
        ...
        {comments.map((comment) => (
          <div key={comment.id} className="rounded-lg bg-slate-50 p-2.5">
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-2">
        ...
        <textarea
          ...
          placeholder="コメントを入力..."
          rows={2}
          className="rounded border border-slate-200 px-2 py-1 text-xs focus:border-blue-400 focus:outline-none resize-none"
        />
        <button
          type="submit"
